...
void ofApp::setup(){
    ...
    growingTriSource = new GrowingTriSource();
    piMapper.registerFboSource(growingTriSource);
    
    slidingTriSource = new SlidingTriSource();
    piMapper.registerFboSource(slidingTriSource);
    
    rotatingTriSource = new RotatingTriSource();
    piMapper.registerFboSource(rotatingTriSource);
...
void ofApp::update(){
    ...
    int numberOfSeconds = 165; // this kills it after 180 sec (change it to whatever you want MAX 180 seconds)
